////////////////////전역 변수//////////////////////////
var vChatHubUrl = "http://m.tas.e-tgl.com:8096/signalr";
//var vChatHubUrl = "http://10.10.2.148:8097/signalr";
...
$(function () { //ready Function
    ...
    //Web.Config의 Y인 경우에만 Push 될 수 있게.
...
function Chathub_Push_Message(obj) {
    ...
    if (_fnToNull(strDomain) != "") {  //도메인 정보가 있을때만 가능하다
        ...
        if (userId != "") {
            ...
            //var FullMsg = strDomain + "|" + userId + "|" + rcv + "|" + "EE" + "|" + "P" + "|" + "EAP" + "|" + Message + "|" + "" + "|" + ref1 + "|" + ref2 + "|" + ref3 + "|" + ref4 + "|" + ref5;
            var FullMsg = strDomain + "|" + userId + "|" + rcv + "|" + "WE" + "|" + "P" + "|" + "EAP" + "|" + Message + "|" + "" + "|" + ref1 + "|" + ref2 + "|" + ref3 + "|" + ref4 + "|" + ref5;
            //alert(FullMsg);
            // alert(userId);
...
function fnPriceComma(vValue) {
    try {
        ...
        if (vPrice.length == 0) {
            ...
            vPrice = vPrice.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',');
            return vPrice;
        }

    }
    catch (err) {
        console.log("[Error - fnUSDComma]" + err.message);
    }
}
/////////////////function MakeList/////////////////////
...
//현재 기준 저번달 첫일 / 다음달 말일 데이터 가져오기 vType = Prev / Next
