            ...
            $.each(vResult, function (i) {
                if (_fnToNull(vResult[i].EVENT_STATUS) == "N") {
                    ...
                    if (_fnToNull(vResult[i].EX_IM_TYPE) == "E") {
                        vHTML += "   		<img src=\"/Images/Masstige/e-service/trc-icon-"+(i+1)+".png\" alt=\"아이콘\" /> ";
                    }
                    else if (_fnToNull(vResult[i].EX_IM_TYPE) == "I") {
                        vHTML += "   		<img src=\"/Images/Masstige/e-service/trc-icon-im-" + (i + 1) +".png\" alt=\"아이콘\" /> ";
                    }
                    vHTML += "   	</div> ";
