...
$(document).on("click", "#layer_FileUpload", function () {
    ...
    if (vBoolean) {
        ...
        alert("Please register the file first.");
    }
...
function fnConsolePaging(totalData, dataPerPage, pageCount, currentPage) {
    ...
    vHTML += "   <ul> ";
    vHTML += "      <li> ";
    vHTML += "      	<a href=\"javascript:;\" class=\"prev-first\" onclick=\"fnConsoleGoPage(1)\" ><span>To the front</span></a> ";
    vHTML += "      </li> ";
    vHTML += "      <li> ";
    vHTML += "      	<a href=\"javascript:;\" class=\"prev\" onclick=\"fnConsoleGoPage(" + prevPage + ")\"><span>Before</span></a> ";
    vHTML += "      </li> ";
    ...
    vHTML += "      <li> ";
    vHTML += "      	<a href=\"javascript:;\" onclick=\"fnConsoleGoPage(" + nextPage + ")\" class=\"next\"><span>Next</span></a> ";
    vHTML += "      </li> ";
    vHTML += "      <li> ";
    vHTML += "      	<a href=\"javascript:;\" onclick=\"fnConsoleGoPage(" + totalPage + ")\" class=\"next-last\"><span>At the very end</span></a> ";
    vHTML += "      </li> ";
    vHTML += "   </ul> ";
    ...
    try {
        ...
        for (var i = 0; i < $(vThis).get(0).files.length; i++) {
            ...
            if (vFileExtension == "BMP" || vFileExtension == "JPG" || vFileExtension == "JPEG" || vFileExtension == "JPE" || vFileExtension == "JFIF" || vFileExtension == "TIF" || vFileExtension == "TIFF" || vFileExtension == "PNG") {
                ...
                alert("Only bmp , jpg , jpeg , jpe , jfif , tif , tiff , png extensions can upload files.");
                return false;
            }
    ...
    try {
        ...
        if (JSON.parse(vJsonData).Result[0]["trxCode"] == "Y") {
            ...
            $.each(vResult, function (i) {
                ...
                vHTML += "   	<p class=\"title font-main\">Actual customer name</p> ";
                ...
                vHTML += "   </li> ";
                vHTML += "   <li class=\"info-txt info-txt--full\"> ";
                vHTML += "   	<p class=\"title font-main\">Cargo Receipt Number</p> ";
                ...
                vHTML += "   </li> ";
                vHTML += "   <li class=\"info-txt info-txt--full\"> ";
                vHTML += "   	<p class=\"title font-main\">Cargo Received Date</p> ";
                ...
                vHTML += "   </li> ";
                vHTML += "   <li class=\"info-txt info-txt--full\"> ";
                vHTML += "   	<p class=\"title font-main\">Weight</p> ";
                ...
                vHTML += "   </li> ";
                vHTML += "   <li class=\"info-txt info-txt--full\"> ";
                vHTML += "   	<p class=\"title font-main\">Pictures</p> ";
                vHTML += "   	<p class=\"des\"> ";
                vHTML += "   		<a href=\"javascript:void(0)\" name=\"layer_ImageUpload\" class=\"link\"> <img src=\"/Images/Masstige/e-service/upload-img.jpg\" alt=\"upload\" /> </a> ";
                vHTML += "   		<input type=\"hidden\" value=\"" + _fnToNull(vResult[i]["BK_NO"]) +"\" /> ";
                vHTML += "   	</p> ";
                vHTML += "   </li> ";
                vHTML += "   <li class=\"info-txt info-txt--full\"> ";
                vHTML += "   	<p class=\"title font-main\">Detail</p> ";
                vHTML += "   	<p class=\"des\"> ";
                vHTML += "   		<a href=\"javascript:void(0)\" name=\"layer_ConsoleData\" class=\"link\"><i class=\"xi-plus\"></i></a> ";
                vHTML += "   		<input type=\"hidden\" name=\"layer_DetailMngtNo\" value=\"" + _fnToNull(vResult[i]["BK_NO"]) + "\" /> ";
                vHTML += "   		<input type=\"hidden\" name=\"layer_DetailSeq\" value=\"" + _fnToNull(vResult[i]["BK_SEQ"]) + "\" /> ";
            ...
            //PC
            vHTML += "   <tr> ";
            vHTML += "   	<td colspan=\"11\" class=\"no_data\"><span class=\"font-weight-medium\">Please check the information you request.</span></td> ";
            vHTML += "   </tr> ";
            ...
            //PC
            vHTML += "   <tr> ";
            vHTML += "   	<td colspan=\"11\" class=\"no_data\"><span class=\"font-weight-medium\">Please contact the administrator.</span></td> ";
            vHTML += "   </tr> ";
