        ...
        if (JSON.parse(vJsonData).Result[0]["trxCode"] == "Y") {
            ...
            $.each(vResult, function (i) {
                ...
                if (_fnToNull(vResult[i]["STATUS"]) == "Q") {
                    ...
                    vHTML += "   	<td class=\"txt txt--b\">승인</td> ";
                }
                else if (_fnToNull(vResult[i]["STATUS"]) == "F") {
                    vHTML += "   	<td class=\"txt txt--b\">확정</td> ";                    
                }
            ...
            $.each(vResult, function (i) {
                ...
                if (_fnToNull(vResult[i]["STATUS"]) == "Q") {
                    ...
                    vHTML += "   	<p class=\"txt--b des\">승인</p> ";                    
                }
                else if (_fnToNull(vResult[i]["STATUS"]) == "F") {
                    vHTML += "   	<p class=\"txt--b des\">확정</p> ";
                }
                else if (_fnToNull(vResult[i]["STATUS"]) == "C") {
