            ...
            success: function (result) {
                ...
                if (JSON.parse(result).Result[0]["trxCode"] == "Y") {
                    ...
                    if (JSON.parse(result).Available[0]["CHKBL_YN"] == "Y") {
                        ...
                        vResult = false;
                        alert("B/L 제출을 먼저 해주시기 바랍니다.");
                    }
                } else {
                    alert("Tracking 정보가 없습니다.");
                    vResult = false;
                }
            }, error: function (xhr, status, error) {                
                alert("담당자에게 문의 하세요.");
        ...
        if (JSON.parse(vJsonData).Result[0]["trxCode"] == "Y") {
            ...
            $.each(vResult, function (i) {
                ...
                if (_fnToNull(vResult[i]["IS_CHKBL_YN"]) == "Y") {
                    ...
                    vHTML += "   		<span class=\"success-btn btn2 icn_state3\" onclick=\"alert('CheckB/L이 없습니다.')\"></span> ";
                }
            ...
            $.each(vResult, function (i) {
                ...
                if (_fnToNull(vResult[i]["IS_CHKBL_YN"]) == "Y") {
                    ...
                    vHTML += "   		<span class=\"success-btn btn1 icn_state3\" onclick=\"alert('CheckB/L이 없습니다.')\"></span> ";
                }
