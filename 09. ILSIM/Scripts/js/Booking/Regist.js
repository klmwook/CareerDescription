    ...
    try
    {
        ...
        if (_fnToNull($("#View_BKG_NO").val()) != "") {
            ...
            if (_objData.STATUS == "Q") {
                vHTML += "          <button type=\"submit\" name=\"booking_list\" class=\"btn_type1 reverse half\">목록</button> ";
                vHTML += "          <button type=\"submit\" name=\"booking_request\" class=\"btn_type1 reverse half\">수정</button> ";
            } else {
