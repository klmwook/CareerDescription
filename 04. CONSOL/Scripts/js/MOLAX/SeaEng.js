...
$(function () {
    ...
    //    $('#start_txt').text('Departure');
    //    $('#arrive_txt').text('Arrival');
    //
...
function fnMakeSchList(vJsonData) {
    ...
    try {
        ...
        if (JSON.parse(vJsonData).Result[0]["trxCode"] == "Y") {
            ...
            //PC
            vHTML += "   <tr> ";
            vHTML += "   	<td class=\"no_data\" colspan=\"10\"><span class=\"font-weight-medium\">Please check the information you request.</span></td> ";
            vHTML += "   </tr> ";
